...
::: {.column style="flex: 1;"}
![](images/grace2.png){fig-align="center" width="70%"}
:::
...
::: {style="width: 100%; margin: auto; font-weight: normal; text-align: center;"}
(I'm in the process of moving my CV [here](https://docs.google.com/document/d/10gc9fmVgzAN75K9mlt206B_PkyuSGwwhJu0l9VwqO80/preview?))

#### **Education**
:::

::: {style="width: 100%; margin: auto; font-weight: normal; text-align: left"}
| **2021 - present**
...
::: {style="width: 100%; margin: auto; font-weight: normal; text-align: center; text-decoration: underline"}
#### **Teaching**
:::
...
| 
| The mission of [Native Plant Trust](https://www.nativeplanttrust.org/) (NPT) is to save rare and endangered plants through conservation, horticulture, and education. As part of my role at NPT, I contributed to the New England Plant Conservation Program (NEPCoP) by assisting in securing permission for rare plant surveys from a variety of land owners, including government agencies, NGOs, and private landowners.
| 
| **2025**
| Research Intern
| Appalachian Mountain Club Jackson, NH
| 
| The [Appalachian Mountain Club](https://www.outdoors.org/) (AMC) aims to protect the outdoors from environmental threats. Their work runs the gamut from maintaining trails to administering a collection of high elevation huts to conducting observational research across New England’s alpine and sub-alpine zones. In my capacity as an intern, I helped develop an alpine pollinator monitoring project under the guidance of senior scientist Georgia Murray.
| 
| **2022 - 2024**
| Picnic Day Co-Chair
...
\
4.     Baiotto, T., C. Cosma, Y. Y. J. Cheung, D. Narango, J. Woodard, P. McCarville, A. Echeverri, **G. Horne**, E. Wood, N. M. Williams, K. C. Seltmann, J. R. Fleri, A. Owens, M. Lequerica Tamara, A. Boren, S. Doneski, R. P. Guralnick, D. Li, and L. M. Guzman. 2026. Local interaction networks reconstructed from global biodiversity data improve pollinator restoration decision making. bioRxiv:2026.03.30.715389.

3.     **Horne, Grace M.**, Lauren Azevedo-Schmidt, and Emily K. Meineke. (in prep.) Herbivory diversity and function: A unifying framework for temporal ecology.

2.     **Horne, Grace M.**, John de Benedictis, Matthew L. Forister, and Emily K. Meineke. (in review) Climate change favors moths able to keep pace with an earlier spring.
:::
...
<head>
    ...
    <style>
        ...
        .altmetric-citation-pair {
            ...
            gap: 15px; /* increased space between altmetric and text */
...
::: {style="width: 100%; margin: auto; font-weight: normal; text-align: left; fig-align: center"}
...
::: {style="width: 100%; margin: auto; font-weight: normal; text-align: left"}
| **2024**
| [wRiting functions in R](https://gracehorne.com/writing-functions-in-R), Entomology graduate students, March 12
| 
| **2023**
...
| 
| **2025**
| AMC Guide to the Pollinators of the WMNF, [full](https://drive.google.com/file/d/1aloFyCDI9kHhKHO_LqxdBAacF8EraHfE/view?usp=drive_link) & [abridged](https://drive.google.com/file/d/15WQ0iC4QMaNe-bYUuI1JUMEZHZpC-vq6/view?usp=drive_link) guides^†^
...
| (collaboratively created [regional biodiversity guides](https://drive.google.com/drive/folders/1HQZsG10TBvSzO29jdyQa9i2nrTin_lov?usp=sharing))
| 
| **2023**
