...
<div style="text-align: center; margin-top: 15px;">
  <a href="mailto:gmhorne@ucdavis.edu" aria-label="email" style="font-size: 24px; color: #282a36; margin: 0 10px;"><i class="bi bi-envelope-heart"></i></a>
  <a href="https://github.com/gracehorne" aria-label="GitHub" style="font-size: 24px; color: #282a36; margin: 0 10px;"><i class="bi bi-github"></i></a>
  <a href="https://scholar.google.com/citations?user=pE2oVU0AAAAJ&hl=en" aria-label="Google Scholar" style="font-size: 24px; color: #282a36; margin: 0 10px;"><i class="bi bi-google"></i></a>
</div>
```
